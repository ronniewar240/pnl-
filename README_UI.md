...
## Multi-option IBKR live tracking

The IBKR Live P&L tab now supports multiple option contracts at once. Add/edit rows in the positions table, keep `enabled` checked for the contracts you want to track, and click **Refresh All IBKR Quotes**.

Each row supports its own underlying, expiry, call/put, strike, entry price, contracts, stop-loss %, and take-profit %.
